...
Pinned baselines: `@a2a-js/sdk@1.1.0`, `@modelcontextprotocol/sdk@1.30.0`, and Codex schema `0.153.2` (compatible build `0.153.4`). The A2A TCK revision has one machine-readable source of truth in [`conformance/a2a-profile-v1.json`](../../conformance/a2a-profile-v1.json).
